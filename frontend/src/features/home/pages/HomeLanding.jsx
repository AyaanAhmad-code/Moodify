                ...
                <div className="hero__container">
                    <div className="hero__content">
                        <div className="hero__badge">
                            ...
                            <span className="hero__badge-text">AI-Powered Music Experience</span>
                        </div>
                        
                        <h1 className="hero__title">
                            Your Face,<br />
                            <span className="hero__title-accent">Your Mood,</span><br />
                            Your Perfect Song
                        </h1>
                        
                        <p className="hero__description">
                            Experience the future of music discovery. Our real-time AI analyzes your 
                            facial expressions to curate the ultimate soundtrack for exactly how you feel.
                        </p>
                    ...
                    <div className="hero__visual">
                        ...
                        <div className="mockup-wrapper">
                            ...
                            <div className="floating-card floating-card--top">🎵 Upbeat Mix</div>
                            <div className="floating-card floating-card--bottom">Analyzing...</div>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="features__container">
                    <div className="features__header">
                        ...
                        <p className="features__subtitle">
                            Cutting-edge technology meets intuitive design for the ultimate music experience
                        </p>
                    </div>
                    <div className="features__grid">
                        <div className="feature-card feature-card--primary">
                            ...
                            <p className="feature-card__description">
                                Advanced computer vision algorithms analyze your facial expressions in real-time,
                                detecting subtle emotional changes with industry-leading accuracy.
                            </p>
                        ...
                        <div className="feature-card">
                            ...
                            <p className="feature-card__description">
                                Our AI-powered recommendation engine matches your detected mood with songs
                                from our curated library, ensuring perfect emotional resonance.
                            </p>
                            <div className="feature-card__metrics">
                        ...
                        <div className="feature-card">
                            ...
                            <p className="feature-card__description">
                                All processing happens locally in your browser. Your facial data never leaves
                        ...
                        <div className="feature-card">
                            ...
                            <p className="feature-card__description">
                                Upload and tag your favorite songs by mood. Help build the most comprehensive
                                mood-based music library in the world.
                            </p>
                            <div className="feature-card__metrics">
                    ...
                    <div className="how-it-works__steps">
                        <div className="step">
                            ...
                            <div className="step__content">
                                ...
                                <p className="step__description">
                                    Allow your browser to access the camera. This enables real-time facial analysis
                                    while keeping all processing local to your device.
                                </p>
                            </div>
                        ...
                        <div className="step">
                            ...
                            <div className="step__content">
                                ...
                                <p className="step__description">
                                    Our advanced MediaPipe-powered facial landmark detection analyzes your
                                    expressions and maps them to emotional states with high precision.
                                </p>
                            </div>
                            <div className="step__visual">
                                <div className="step__icon">
                        ...
                        <div className="step">
                            ...
                            <div className="step__content">
                                ...
                                <p className="step__description">
                                    Instantly receive song recommendations that perfectly match your detected mood.
                                    Stream, skip, and discover new favorites effortlessly.
                                </p>
                            </div>
                            <div className="step__visual">
                                <div className="step__icon">
                    ...
                    <div className="demo__content">
                        ...
                        <div className="demo__video">
                            <div className="video-placeholder">
                                ...
                                <small>Real-time facial emotion detection & music matching</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="cta">
                <div className="cta__container">
                    <div className="cta__content">
                        <h2 className="cta__title">Ready to Experience the Future of Music?</h2>
                        <p className="cta__description">
                            Join thousands of users who have discovered their perfect mood-matched soundtracks
                        </p>
